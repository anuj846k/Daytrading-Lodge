...
export const Header19 = (props: Header19Props) => {
  ...
  return (
    <header className="px-[5%] py-20 md:py-24 font-switzer bg-gradient-to-b  md:from-orange-50  to-white ">
      <div className="container mx-auto">
        <div className="grid grid-cols-1  gap-x-48 gap-y-12 md:gap-y-16 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            <Trading />
          </div>
          <div className="order-1 lg:order-2 p-4 lg:p-6 w-full lg:w-[80%] md:ml-48  rounded-3xl shadow-lg bg-gray-50   ">
            ...
            <img
              src="./Trading.gif"
              alt=""
              className="md:hidden block h-40 w-40"
            />
