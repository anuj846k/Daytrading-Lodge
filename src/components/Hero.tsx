      ...
      >
        <div className="left w-full md:w-[70%] flex flex-col justify-center md:items-start items-center p-8 md:p-14 shadow-lg">
          <div className="font-switzer text-black">
            <h1
              id="hero-heading"
              className="text-6xl -mt-4 md:-mt-2 md:mb-7 md:text-[90px] md:leading-none font-bold font-switzer"
            >
          ...
          <div className="mt-8 md:mt-10 flex flex-col items-center justify-center md:flex-row gap-4 md:gap-8">
            <button
              className="text-white px-6 md:px-12 py-3 text-lg md:text-xl bg-[#D71E2E] rounded-full shadow-lg hover:bg-[#b81a27] transition duration-300 hover:shadow-2xl transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#b81a27]"
              aria-label="Download Brochure"
            >
              Download Brochure
            </button>
            <button
              className="text-white px-16 md:px-12 py-3 text-lg md:text-xl bg-[#2866C4] rounded-full shadow-lg hover:bg-[#2459a3] transition duration-300 hover:shadow-2xl transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2459a3]"
